...
const ProfileContentStack =
  createStackNavigator<ProfileContentNavigatorParamsList>();

export function ProfileContentNavigator() {
  return (
    <ProfileContentStack.Navigator screenOptions={{ headerShown: false }}>
      <ProfileContentStack.Screen
        name="DomainOfTasteScreen"
        component={DomainOfTasteScreen}
      />
      <ProfileContentStack.Screen
