...
const CurrentUserContext = createContext<{ currentUser: User | null; setCurrentUser: React.Dispatch<React.SetStateAction<User | null>> } | null>(null);
      ...
      if (firebaseUser) {
        ...
        const unsubscribeFirestore = onSnapshot(userRef, documentSnapshot => {
            if (documentSnapshot.exists()) {
                setCurrentUser({ userId: firebaseUser.uid, ...documentSnapshot.data() as User });
            } else {
