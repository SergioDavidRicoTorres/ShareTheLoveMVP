...
type SpotifyAuthContextType = {
  ...
  export const useSpotifyAuth = () => useContext<SpotifyAuthContextType>(SpotifyAuthContext);
...
export const SpotifyAuthProvider = ({ children }: SpotifyAuthProviderProps) => {
  ...
  return (
    <SpotifyAuthContext.Provider value={{ isSpotifyAuthenticated, setIsSpotifyAuthenticated }}>
      {children}
